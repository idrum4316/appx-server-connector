...
break}return r?document.getElementById(e.attr("id")).selectionStart:-1}function clearAndReset(){appx_session.pendingTables=0
for(name in CKEDITOR.instances){$(".ui-tooltip").remove()
var e
CKEDITOR.instances[name].element&&(e=CKEDITOR.instances[name].element.$,e.value=""),name.indexOf("stale")===-1&&"unloaded"!==CKEDITOR.instances[name].status&&CKEDITOR.instances[name].destroy(!0),e&&(e.style.display="none")}}function callValidateText(){$("input, textarea").on("input",function(){var e=this
...
appx_session.ws.send(JSON.stringify(o))}catch(n){console.log(n),console.log(n.stack)}}function invalidTableData(){$("td:contains('(???)')").length>0&&alert(appx_session.language.alerts.characterError)}function appxEncodingError(e){var r=appx_session.language.alerts.encodingFrontError+e+appx_session.language.alerts.encodingBackError
appxSetStatusText(r,2)}function uploadFileToMongo(e,r,a){var o=appx_session.uploadURL+encodeURI(r.replace(/ /g,"_")),n=new XMLHttpRequest
...
a.href=e,a.download=r,a.target="_blank",document.body.appendChild(a),a.click(),document.body.removeChild(a)}}APPX.DateFormatter2=function(e,r,a){function o(e){return e<10?"0"+e:e}function n(e,r,a){var o=r.indexOf(a)
return o<0?"--":e.substr(o,2)}var t=r.replace(/y/g,"yy").replace(/yyyy/g,"ccyy"),s=a.replace(/HH/g,"hh").replace(/l/g,"ll"),l=new Date,p=o(l.getHours()),i=o(l.getMinutes()),c=o(l.getSeconds()),d=o(Math.floor(l.getMilliseconds()/10)),u=p+":"+i+":"+c+"."+d,f=""
