...
if(0==d?$(s).addClass("tbdisabled"):$(s).click(function(){appxwidgetcallback(this.id)}),null!==a.widget.wColorBg&&$(s).css("background-color",a.widget.wColorBg),null!=a.widget.wCommand&&a.widget.wCommand===OPT_WHATS_THIS?$(s).addClass("appx-title-button-help"):$(s).attr("id",addClientId(a.widget.wCommand,a.widget.wClientId)),a.widget.wTooltip?($(s).prop("title",a.widget.wTooltip),$(s).tooltip({content:function(){return"function"==typeof this.title?this.title():""}})):a.widget.wLabel&&($(s).prop("title",a.widget.wLabel),$(s).tooltip({content:function(){return"function"==typeof this.title?this.title():""}})),a.widget.wCommand>255){256==a.widget.wcommand&&console.log("Creating delete")
var p=$(s).clone()
null!=a.widget.wCommand&&a.widget.wCommand===OPT_WHATS_THIS?$(s).addClass("appx-title-button-help"):($(p).attr("id",addClientId("sk_"+a.widget.wCommand,a.widget.wClientId)),$(p).click(function(){var e=getClientId(this.id).replace("sk_","")
appxwidgetcallback(e)})),$(p).css({"background-color":"transparent"}),r.over255.push(p)}else r.under256.push(s)}}for(var t=0;t<r.over255.length;t++)$("#toolbar").append(r.over255[t])
