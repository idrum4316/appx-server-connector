...
logca("item focus: "+a[1]+"."+a[2]),appxPutCursor(a[1],a[2]),!appx_session.lastOption||"333"!==appx_session.lastOption&&333!==appx_session.lastOption||$(this).is("input[type=checkbox]")||$(this).is(".checkbox-label")?appx_session.getProp("autoSelect")&&$(this).select():this.selectionStart=this.selectionEnd=appx_session.keyPauseLastPosition}),null===_.widget.wCommandLostFocus&&appxAttachBlur(i,"block"),appxwidgetdimensions(_,i),appxwidgetshandlerprops(_,i),appxIsToken(_)&&appxIsModifiable(_)&&(s==WIDGET_TYPE_LISTBOX||null==s)){var l=appx_session.server.replace(/\./g,"_")+"_"+appx_session.port+"_"+_.token_cacheid+"_"+_.token_app+"_"+_.token_ap_ver+"_"+_.token_cache_sig
