 ...
 *********************************************************************/
"use strict"
function appxitembox(a,e,t,s){for(var p=null,_=null,i=(appx_session.screencols*appx_session.screenrows,appx_session.current_show.boxes),o=0;o<i.length;o++){var n=i[o]
e>=n.begin_column&&e<=n.end_column&&a>=n.begin_row&&a<=n.end_row&&(_=n,e+s-1<=n.end_column&&a+t-1<=n.end_row&&(p=n))}return null==p&&(p=_),null!=p&&p.newbox>=0&&(p=i[p.newbox]),p}function appxcreateformatitem(a,e){var t=null,s=$("<input type='text'>")
e&&(s=e)
var p=""
s.addClass("masked"),t||(t=parseItemLongData(a.rawdata))
for(var _=t.itemdata[1][0].replace(/\_/g,"*"),i=0;i<t.itemdata[1][0].length;i++)"X"==t.itemdata[1][0][i]?_=_.replace(_[i],t.itemdata[0][0][i]):p+=t.itemdata[0][0][i]
return s.inputmask(_,{placeholder:" ",insertMode:!1,clearMaskOnLostFocus:!1}),s.val(p),s}function appxLogicToAlpha(a){return"y"==a.charAt(0)||"Y"==a.charAt(0)||"1"==a.charAt(0)?"Y":"n"==a.charAt(0)||"N"==a.charAt(0)||"0"==a.charAt(0)?"N":""}function appxitemshandler(a){var e=!1
try{appx_session.items.length=0
for(var t=0,s=null,p=null;a.data.length>0;){if(s=null,p=null,_);var _=a.data.shift(),i=$("<div>")
switch(_.uline=appxIsUline(_),appxSetModifiableCapable(_,!1),_.type){case ELEM_ALP_CONTIG:case ELEM_ALP_NON_CONTIG:case ELEM_ALP_SUBSTR:case ELEM_ALP_CMPRS:var o=_.digits_right,n=_.digits_left
o<0&&(o+=256),n<0&&(n+=256),(void 0==_.maxLen||_.maxLen<=0)&&(_.maxLen=256*n+o)
break
case ELEM_ALP_JUL_DATE:case ELEM_ALP_GREG_DATE:case ELEM_BIN_JUL_DATE:case ELEM_BIN_GREG_DATE:case ELEM_PD_JUL_DATE:case ELEM_PD_GREG_DATE:case ELEM_UNIVERSAL_DATE:(void 0==_.maxLen||_.maxLen<=0)&&(_.maxLen=_.size_rows*_.size_cols),p||(p=parseItemLongData(_.rawdata)),_.data=p.itemdata[0][0]
break
default:(void 0==_.maxLen||_.maxLen<=0)&&(_.maxLen=_.size_rows*_.size_cols)}if(_.widget=new Widget(0,"",_.widget),s=_.widget.wWidgetType,s!=WIDGET_TYPE_HTML_VIEWER&&s!=WIDGET_TYPE_HTML_EDITOR&&0==appxIsModifiable(_)&&(_.data=sanitizeText(_.data,null)),_.type==ELEM_LOG&&null==s&&(s=WIDGET_TYPE_CHECK_BOX,_.widget.wWidgetType=WIDGET_TYPE_CHECK_BOX),0!=appxIsModifiable(_)||0!=appxIsModifiableCapable(_)||0!=appxIsStatus(_)||null!=s){if(appxIsModifiable(_)?(_.data=_.data.replace(/\xB6/g,"\r\n").replace(/ *$/gm,""),null==s&&2==(2&_.special)&&(s=WIDGET_TYPE_LISTBOX,_.widget.wWidgetType=WIDGET_TYPE_LISTBOX),null==s&&(s=WIDGET_TYPE_RAW_TEXT,_.widget.wWidgetType=WIDGET_TYPE_RAW_TEXT)):(_.data=_.data.replace(/\xB6/g,"<br/>").replace(/ *$/gm,""),null==s?(s=WIDGET_TYPE_LABEL,_.widget.wWidgetType=WIDGET_TYPE_LABEL):s!=WIDGET_TYPE_FILE_CHOOSER&&s!=WIDGET_TYPE_DATE_CHOOSER&&s!=WIDGET_TYPE_LISTBOX&&s!=WIDGET_TYPE_COLOR_CHOOSER||(_.widget.wLabel=null,_.widget.wWidgetType=WIDGET_TYPE_RAW_TEXT,_.widget.wWidgetOriginalType=s,s=WIDGET_TYPE_RAW_TEXT)),"function"!=typeof appx_session.createWidgetTag[s]){var T=appx_session.createWidgetTag["default"](_.widget,i)
...
_.size_rows>1?d.css("white-space","pre-wrap"):d.css("white-space","pre"),d.html(_.data).appendTo(i)}else _.type==ELEM_LOG&&(_.data=appxLogicToAlpha(_.data)),i.html(_.data)
...
T.inputmask(e,{insertMode:!1}),T.val(a.itemdata[0])}catch(l){console.log("parseItemDateData: "+l),console.log(l.stack)}return{data:a.itemdata[0][0],hasDate:o,df:d,dv:T}}function parseItemLongData(a){var e=[]
try{e.push(91),e.push(34)
for(var t=0;t<a.length;t++)2==a[t]||1==a[t]?(2==a[t]&&(e.push(34),e.push(44),e.push(34)),1==a[t]&&(e.push(34),e.push(93),e.push(44),e.push(91),e.push(34))):0===a[t]?e.push(32):34===a[t]?(e.push(92),e.push(a[t])):e.push(a[t])
return e.push(34),e.push(93),JSON.parse('{"itemdata": ['+ab2str(e).replace(/\n/g,"\\\\n").replace(/\r/g,"\\\\r")+"]}")}catch(s){return console.log("parseItemLongData: "+s),console.log("parseItemLongData: data="+e),console.log(s.stack),e=[91,34,34,93],JSON.parse('{"itemdata": ['+ab2str(e)+"]}")}}var FLD_OPT_NULLOK=1,FLD_OPT_UCASE=2,FLD_OPT_MASK=4,FLD_OPT_SCAN=8,FLD_OPT_STAT_BITS=240,FLD_OPT_STAT_DB=16,FLD_OPT_STAT_AP=32,FLD_OPT_STAT_VER=48,FLD_OPT_STAT_USER=64,FLD_OPT_STAT_DATE=80,FLD_OPT_STAT_KEYMAP=96,FLD_OPT_STAT_MSG=112,FLD_OPT_STAT_MODE=128,FLD_OPT_STAT_EMBLD=144,FLD_OPT_STAT_PROGRESS=160,FLD_SPEC_TOKEN=2,FLD_SPEC_WORD_WRAP=4,FLD_SPEC_MOD_ABLE=8,FLD_SPEC_ULINE=8,FLD_SPEC_DLU_TABOUT=64,FLD_SPEC_MOD=128,ELEM_NONE=0,ELEM_ALP_CONTIG=1,ELEM_ALP_NON_CONTIG=2,ELEM_ALP_JUL_DATE=3,ELEM_ALP_GREG_DATE=4,ELEM_BIN=5,ELEM_BIN_JUL_DATE=6,ELEM_BIN_GREG_DATE=7,ELEM_PD_FIX=8,ELEM_PD_JUL_DATE=9,ELEM_PD_GREG_DATE=10,ELEM_LOG=11,ELEM_PD_VAR=12,ELEM_ALP_SUBSTR=13,ELEM_ALP_CMPRS=14,ELEM_UNIVERSAL_DATE=15
