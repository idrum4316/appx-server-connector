...
break
case ELEM_ALP_JUL_DATE:case ELEM_ALP_GREG_DATE:case ELEM_BIN_JUL_DATE:case ELEM_BIN_GREG_DATE:case ELEM_PD_JUL_DATE:case ELEM_PD_GREG_DATE:case ELEM_UNIVERSAL_DATE:p||(p=parseItemLongData(_.rawdata)),_.data=p.itemdata[0][0]}if(_.widget=new Widget(0,"",_.widget),s=_.widget.wWidgetType,_.type==ELEM_LOG&&null==s&&(s=WIDGET_TYPE_CHECK_BOX,_.widget.wWidgetType=WIDGET_TYPE_CHECK_BOX),0!=appxIsModifiable(_)||0!=appxIsModifiableCapable(_)||0!=appxIsStatus(_)||null!=s){if(appxIsModifiable(_)?(_.data=_.data.replace(/\xB6/g,"\r\n").replace(/ *$/gm,""),null==s&&2==(2&_.special)&&(s=WIDGET_TYPE_LISTBOX,_.widget.wWidgetType=WIDGET_TYPE_LISTBOX),null==s&&(s=WIDGET_TYPE_RAW_TEXT,_.widget.wWidgetType=WIDGET_TYPE_RAW_TEXT)):(_.data=_.data.replace(/\xB6/g,"<br/>").replace(/ *$/gm,""),null==s?(s=WIDGET_TYPE_LABEL,_.widget.wWidgetType=WIDGET_TYPE_LABEL):s!=WIDGET_TYPE_FILE_CHOOSER&&s!=WIDGET_TYPE_DATE_CHOOSER&&s!=WIDGET_TYPE_LISTBOX||(_.widget.wLabel=null,_.widget.wWidgetType=WIDGET_TYPE_RAW_TEXT,s=WIDGET_TYPE_RAW_TEXT)),"function"!=typeof appx_session.createWidgetTag[s]){var d=appx_session.createWidgetTag["default"](_.widget,i)
i=d.tag,_.widget=d.widget,s=_.widget.wWidgetType}else s===WIDGET_TYPE_DATE_CHOOSER?(d=appx_session.createWidgetTag[s](_.widget,i,_,p),i=d.tag,p=d.longdata):i=appx_session.createWidgetTag[s](_.widget,i,_)
...
else{if(s==WIDGET_TYPE_NONE||s==WIDGET_TYPE_RAW_TEXT||s==WIDGET_TYPE_LABEL){if(i=$("<div>"),null!==_.widget.wSepBefore&&_.widget.wSepBefore===!0&&i.addClass("sepBefore"),null!==_.widget.wSepAfter&&_.widget.wSepAfter===!0&&i.addClass("sepAfter"),s!=WIDGET_TYPE_LABEL&&i.addClass("appx-raw-text"),_.pos_row<=appx_session.screenrows-3)if(_.size_rows>1||s!=WIDGET_TYPE_LABEL){var T=$("<div>")
_.size_rows>1?T.css("white-space","pre-wrap"):T.css("white-space","pre"),T.html(_.data).appendTo(i)}else _.type==ELEM_LOG&&(_.data="1"==_.data?"Y":"0"==_.data?"N":""),i.html(_.data)
...
var n='{"value":"'+s+'","datemsk":"'+p+'","timemsk":"'+_+'"}',d=$("<input class='appxdatevalue appxitem' type='text' style='width: 100%; height: 100%'>"),T=$("<input class='appxdatepicker' type='hidden'>").val(n)
d.inputmask(t,{insertMode:!1}),d.val(a.itemdata[0])}catch(r){console.log("parseItemDateData: "+r),console.log(r.stack)}return{data:a.itemdata[0][0],hasDate:o,df:T,dv:d}}function parseItemLongData(a){var t=[]
