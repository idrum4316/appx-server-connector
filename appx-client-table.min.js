...
appxTableApplyColumnStyle(T,E)}var M={left:"",top:"",drag:!0,multipleSearch:!0,searchOnEnter:!0,closeAfterSearch:!0,closeOnEscape:!0,stringResult:!0,beforeShowSearch:function(){var e=$(".ui-jqdialog"),t=(r-e.width())/2,a=(s-e.height())/2
return e.css("left",t+"px").css("top",a+"px"),!0}},I=!0
0==a._widgetData.tableShowTableSearch&&(I=!1)
var P=!0
if(0==a._widgetData.tableShowTableRefresh&&(P=!1),C.jqGrid("navGrid","#"+a._pagerElemId,{edit:!1,add:!1,del:!1,refresh:P,search:I,beforeRefresh:function(){a._clearSelections(),a._prefsData.filters=void 0}},{},{},{},M),e._addButtonsToFooter(a,o),d>0&&$("#"+a._gviewElemId+" .ui-jqgrid-titlebar").css("height",d+"px"),0==this._widgetData.tableShowHeading){var k=document.querySelector("#"+a._gviewElemId+" > .ui-jqgrid-hdiv")
null!=k&&(k.style.display="none")}0==this._widgetData.wEnabled&&$("#"+this._gridElemId).addClass("jqgrid-disabled-widget"),$("#newtablewidget_"+o).closest(".appxbox").hasClass("appx-not-modifiable")&&$("#newtablewidget_"+o).closest(".ui-jqgrid").block({message:null,overlayCSS:{backgroundColor:"#000",opacity:0,cursor:null}})},e.prototype._beforeSelectRow=function(t,a,o){var l=this
