...
for(var s=0;s<i._tableData.colModel.length;s++)i._tableData.colMap.push(s)
...
l.open("POST",o),l.setRequestHeader("Content-type","application/json"),l.onreadystatechange=function(){if(4===l.readyState&&200===l.status){var e=JSON.parse(l.responseText).prefData
null!=e?t._prefsSrvSnap=e:t._prefsSrvSnap="{}",t._adjustGridIconColors(),"{}"!==e&&null!=e&&(t._prefsData=JSON.parse(e))}t._prefsDataReceived=!0}
...
"{}"===e._prefsSrvSnap?($("#"+e._optionElemId).removeClass("jqgrid-options-highlight"),$("#table-save").removeClass("jqgrid-options-highlight")):($("#"+e._optionElemId).addClass("jqgrid-options-highlight"),$("#table-save").addClass("jqgrid-options-highlight"))},e.prototype._pushTablePref=function(){var t=this,a=$("#"+t._appxElemId),o=e._getAppxSession()
...
i.colModel=l.getGridParam("colModel"),void 0!==i.filters&&i.filters.length>0&&(i._search="true"),i.keyBeg=e,i.keyEnd=t
...
if("BlankTable"!=t._tableData.datalookupid&&(e={collection:t._tableData.collection,datalookupid:t._tableData.datalookupid,collist:t._tableData.collist,lastSortName:t._prefsData.lastSortName||[],lastSortOrder:t._prefsData.lastSortOrder||[],search:!1,caseSort:t._widgetData.tableCaseSort},t._prefsData.filters&&(e.filters=t._prefsData.filters,e.search=!0)),t._transData.tableLoaded===!1&&JSON.stringify(t._prefsData.lastSortName)!==JSON.stringify(["initialSort"])){var a=t.selectedKeys
...
if(s&&s[e]&&s[e][l.name]&&s[e][l.name].widget_data){s[e][l.name].widget=appxTableRowWidgetHandler(s[e][l.name].widget_data),s[e][l.name].widget_data=null,r=s[e][l.name].widget
var n=!1
...
var y={}
y.shrinkToFit=!1,y.height=s-4-n-p-d,d>0&&(y.height-=1),0==p&&(y.height+=1),y.width=c,y.scrollOffset=f,y.mtype="POST",y.caption=a._widgetData.wLabel||"",y.colModel=h,y.datatype="json",y.hidegrid=!1,y.multiselect=!0,y.rowList=[10,20,30,40,50],y.scroll=a._getVirtualScroll(),y.viewrecords=!0,y.gridview=!0,y.loadonce=!1,y.scrollrows=!1,y.sortname=(a._prefsData.lastSortName||["initialSort"]).slice(-1)[0],y.sortorder=(a._prefsData.lastSortOrder||["asc"]).slice(-1)[0],y.rownumbers=a._widgetData.tableShowRowNumbers,y.postData=a._getPostData(),y.search=!(!y.postData||!y.postData.filters),y.rownumWidth=u,y.rowNum=a._prefsData.rowsPerPage||50,y.url=e._getAppxSession().appxDataCacheUrl,y.pager="#"+a._pagerElemId,y.page=a._getPage(),a._widgetData&&0==a._widgetData.tableMovableColumn?y.sortable=!1:y.sortable=function(e){a._columnMoved(this,e)},y.resizeStop=function(e,t){a._columnResized(this,e,t)},y.gridComplete=function(){a._gridComplete(this)},y.loadComplete=function(e){a._loadComplete(this,e)},y.onSelectRow=function(e,t,o){a._onSelectRow(this,e,t,o)},y.beforeSelectRow=function(t,o){return!(a._transData.clickDetect&&Date.now()-a._transData.clickDetect<e._DOUBLE_CLICK_TIMER)&&(a._transData.clickDetect=Date.now(),a._beforeSelectRow(this,t,o))},y.ondblClickRow=function(e,t,o,l){a._onDblClickRow(this,e,t,l)},y.loadBeforeSend=function(e,t){a._loadBeforeSend(this,e,t)}
var C=$("#"+a._gridElemId).jqGrid(y),x=C.jqGrid("getGridParam","postData")
x&&(a._prefsData.filters?(x.search=!0,x.filters=a._prefsData.filters):(x.search=!1,x.filters=void 0)),C.jqGrid("hideCol","cb")
for(var S=0;S<a.colModel.length;S++)if(a.colModel[S].align&&C.jqGrid("setLabel",a.colModel[S].name,"",{"text-align":a.colModel[S].align}),D&&D[a.colModel[S].name]&&D[a.colModel[S].name].widget){var T=D[a.colModel[S].name].widget,E=$("#jqgh_"+a._gridElemId+"_"+a.colModel[S].name)
appxTableApplyColumnStyle(T,E)}var I={left:"",top:"",drag:!0,multipleSearch:!0,searchOnEnter:!0,closeAfterSearch:!0,closeOnEscape:!0,stringResult:!0,beforeShowSearch:function(){var e=$(".ui-jqdialog"),t=(r-e.width())/2,a=(s-e.height())/2
return e.css("left",t+"px").css("top",a+"px"),!0}},M=!0
0==a._widgetData.tableShowTableSearch&&(M=!1)
var P=!0
if(0==a._widgetData.tableShowTableRefresh&&(P=!1),C.jqGrid("navGrid","#"+a._pagerElemId,{edit:!1,add:!1,del:!1,refresh:P,search:M,beforeRefresh:function(){a._clearSelections(),a._prefsData.filters=void 0}},{},{},{},I),e._addButtonsToFooter(a,o),d>0&&$("#"+a._gviewElemId+" .ui-jqgrid-titlebar").css("height",d+"px"),0==this._widgetData.tableShowHeading){var R=document.querySelector("#"+a._gviewElemId+" > .ui-jqgrid-hdiv")
null!=R&&(R.style.display="none")}$("#newtablewidget_"+o).closest(".appxbox").hasClass("appx-not-modifiable")&&$("#newtablewidget_"+o).closest(".ui-jqgrid").block({message:null,overlayCSS:{backgroundColor:"#000",opacity:0,cursor:null}})},e.prototype._beforeSelectRow=function(t,a,o){var l=this
...
l._transData.clickTimer&&(clearTimeout(l._transData.clickTimer),l._transData.clickTimer=void 0),null!=l._widgetData.wCommand2&&l._widgetData.wCommand2>=0&&$(e).closest(".appxbox").hasClass("appx-not-modifiable")===!1&&appxIsLocked()===!1&&appxwidgetcallback(l._widgetData.wCommand2)},e.prototype._columnMoved=function(e,t){this._prefsData.colMap=t},e.prototype._columnResized=function(e,t,a){this._prefsData.colModel=$(e).jqGrid("getGridParam","colModel")},e.prototype._gridComplete=function(e){var t=this,a=(t.selectedKeys,t._widgetData),o=$("#"+t._appxElemId).css("font-size"),l=$("#"+t._appxElemId).css("line-height")
if($("#"+t._gviewElemId+" div").not(".appx-fontsize-adjusted").css({"font-size":o,"line-height":l,"padding-top":"0px","padding-bottom":"0px"}),a){var i={}
...
null!=i&&i>0&&(e.width=i)}return e},e}()
