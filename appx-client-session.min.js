...
appx_session.ws.send(JSON.stringify(s)),s={cmd:"appxmessage",args:appxclientversion,handler:"appxinithandler",data:null},appx_session.ws.send(JSON.stringify(s))}function sendappxfeatures(){var s={cmd:"appxmessage",args:appx_session.feature_mask,handler:"appxfeatureshandler",data:null}
appx_session.ws.send(JSON.stringify(s))}function sendappxextendedfeatures(){var s={cmd:"appxmessage",args:appx_session.extended_feature_mask,handler:"appxextendedfeatureshandler",data:null}
appx_session.ws.send(JSON.stringify(s))}function sendappxconstants(){var s=[["pref.readServerStack","true"],["screen.height",screen.height.toString()],["screen.width",screen.width.toString()],["browser.name",navigator.appName],["browser.version",navigator.appVersion],["browser.userAgent",navigator.userAgent],["browser.language",navigator.language],["client.version",appx_session.getProp("serverConnectorVersionStr")],["client.version.num",appx_session.getProp("serverConnectorVersionNum").toString()],["localConnector",appx_session.localConnectorRunning.toString()],["line.separator",appx_session.lineSeparator]]
