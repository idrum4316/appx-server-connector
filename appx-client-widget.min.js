...
$("#appx_main_container").focus(),$(".dirty").each(function(){o.push(this)}),1==appx_session.processhelp&&(appx_session.processhelpoption=e,e=OPT_HELP_OPT),sendappxshow(e,o)}}function appxwidgetdimensions(e,t,a){try{var s,o,i,l=0,n=0,r=0,p=0,w=e,d=appx_session.colWidthPx,c=appx_session.rowHeightPx
if(s=w.hasOwnProperty("widget")?w.widget.wWidgetType:w.wWidgetType,a&&(l=a.begin_column-1,n=a.begin_row,appxIsScrollReg(a)||n--),w.hasOwnProperty("wWidgetId")||(e.hasOwnProperty("widget")&&null!=e.widget&&null!=e.widget.wPositionX?(w=e.widget,s!=WIDGET_TYPE_PROGRESS_BAR&&s!=WIDGET_TYPE_SLIDER&&(w.wSizeW||(w.wSizeW=e.size_col||e.size_cols),w.wSizeH||(w.wSizeH=e.size_row||e.size_rows))):(l=w.pos_col*d,n=w.pos_row*c,r=(w.size_cols||w.size_col)*d,p=(w.size_rows||w.size_row)*c)),w.hasOwnProperty("wWidgetId")){var g=0,T=0,u=0,h=0
w.wOffsetX&&(g=~~(w.wOffsetX*d/100)),w.wOffsetY&&(T=~~(w.wOffsetY*c/100)),w.wOffsetW&&(u=~~(w.wOffsetW*d/100)),w.wOffsetH&&(h=~~(w.wOffsetH*c/100)),null!=w.wPositionX&&(l=w.wPositionX?(w.wPositionX-l)*d+g:0,n=w.wPositionY?(w.wPositionY-n)*c+T:0,r=w.wSizeW?w.wSizeW*d+u:0,p=w.wSizeH?w.wSizeH*c+h:0)}if(t){o=e.pos_row,i=e.pos_col
...
wt!=WIDGET_TYPE_CHECK_BOX&&$tag.html("")}switch(wt){case WIDGET_TYPE_LINE:wx.wSizeH||(wx.wSizeH=wx.size_row),wx.wSizeW||(wx.wSizeW=wx.size_col)
