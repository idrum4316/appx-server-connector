...
if(s=w.hasOwnProperty("widget")?w.widget.wWidgetType:w.wWidgetType,a&&(l=a.begin_column-1,n=a.begin_row,appxIsScrollReg(a)||n--),w.hasOwnProperty("wWidgetId")||(e.hasOwnProperty("widget")&&null!=e.widget&&null!=e.widget.wPositionX?(w=e.widget,s!=WIDGET_TYPE_PROGRESS_BAR&&s!=WIDGET_TYPE_SLIDER&&(w.wSizeW||(w.wSizeW=e.size_col||e.size_cols),w.wSizeH||(w.wSizeH=e.size_row||e.size_rows))):(l=w.pos_col*d,n=w.pos_row*c,r=(w.size_cols||w.size_col)*d,p=(w.size_rows||w.size_row)*c)),w.hasOwnProperty("wWidgetId")){var g=0,h=0,u=0,T=0
w.wOffsetX&&(g=~~(w.wOffsetX*d/100)),w.wOffsetY&&(h=~~(w.wOffsetY*c/100)),w.wOffsetW&&(u=~~(w.wOffsetW*d/100)),w.wOffsetH&&(T=~~(w.wOffsetH*c/100)),null!=w.wPositionX&&(l=w.wPositionX?(w.wPositionX-l)*d+g:0,n=w.wPositionY?(w.wPositionY-n)*c+h:0,r=w.wSizeW?w.wSizeW*d+u:0,p=w.wSizeH?w.wSizeH*c+T:0)}if(t){o=e.pos_row,i=e.pos_col
