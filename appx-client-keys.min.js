 ...
 **
 *********************************************************************/
function isNumericKey(e){return e.which>=48&&e.which<=57||e.which>=96&&e.which<=105}function enterAltCtrlTextBreak(e){if(null!=e&&(10==e.which||13==e.which)&&"textarea"==e.target.type&&(1==appx_session.getProp("textReverseEnterKey")&&!(e.altKey||e.ctrlKey||e.shiftKey)||0==appx_session.getProp("textReverseEnterKey")&&(e.altKey||e.ctrlKey||e.shiftKey))){var t=e.target,a=t.value
...
p?i.row-o<l&&(s=!1,appxwidgetcallback(OPT_SCROLL_DOWN)):i.row+o>d&&(s=!1,appxwidgetcallback(OPT_SCROLL_UP))}if(e.which>=37&&e.which<=40){if(e.target&&$(e.target).hasClass("appxitem")&&!r){var h="appxitem_"+i.col+"_"+i.row
h==$(e.target).attr("id")&&(s=!1)}s&&(appx_session.showCursor=!0)}if(e.which>=65&&e.which<=90&&e.altKey){var T=$(".appx-shortcut-"+e.which)
T.length>0&&T.is("button")&&(T.click(),t=!1)}else(e.altKey||18==e.which)&&(e.preventDefault(),1==$("body").hasClass("showaccesskeys")?$("body").attr("class",""):$("body").attr("class","showaccesskeys"))
