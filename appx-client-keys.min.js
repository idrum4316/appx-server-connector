 ...
 **
 *********************************************************************/
function enterAltCtrlTextBreak(e){if(null!=e&&(10==e.which||13==e.which)&&"textarea"==e.target.type&&(1==appx_session.getProp("textReverseEnterKey")&&!(e.altKey||e.ctrlKey||e.shiftKey)||0==appx_session.getProp("textReverseEnterKey")&&(e.altKey||e.ctrlKey||e.shiftKey))){var t=e.target,a=t.value
if("number"==typeof t.selectionStart&&"number"==typeof t.selectionEnd){var s=t.selectionStart
t.value=a.slice(0,s)+"\n"+a.slice(t.selectionEnd),t.selectionStart=t.selectionEnd=s+1}else if(document.selection&&document.selection.createRange){t.focus()
var i=document.selection.createRange()
i.text="\r\n",i.collapse(!1),i.select()}return!0}return!1}function fixKeyEvent(e){if("number"==typeof e)e={altKey:!1,ctrlKey:!1,"target.type":"",which:e}
...
try{if(void 0!==e.currentTarget.activeElement&&$(e.currentTarget.activeElement.offsetParent).parents(".searchFilter").length>0||$("#cke_clone").length>0||$(e.currentTarget.activeElement).hasClass("ui-pg-input"))return
...
optionTriggered>0&&e.which!=appx_session.getProp("mapOptionKey")&&(e.which<48||e.which>57)&&(optionTriggered=0,digits=[])
var s=!0,i=appxGetCursorPos(),o=!1,r=1,n=$(e.target).parent()
if((38===e.which||40===e.which)&&n.hasClass("appx-scroll-act")){o=!0
var c=$(e.target).attr("id"),p=38===e.which
parseInt(c.substring(c.lastIndexOf("_")+1))!==i.row&&(r=n.height()/21)
var _
$(".appx-scroll").each(function(){$(this).css("z-index")==n.css("z-index")&&(_=$(this))})
var l=_.position().top/21,d=Math.floor(_.height()/21)+l
p?i.row-r<l&&(s=!1,appxwidgetcallback(OPT_SCROLL_DOWN)):i.row+r>d&&(s=!1,appxwidgetcallback(OPT_SCROLL_UP))}if(e.which>=37&&e.which<=40){if(e.target&&$(e.target).hasClass("appxitem")&&!o){var h="appxitem_"+i.col+"_"+i.row
h==$(e.target).attr("id")&&(s=!1)}s&&(appx_session.showCursor=!0)}if(e.which>=65&&e.which<=90&&e.altKey){var u=$(".appx-shortcut-"+e.which)
u.length>0&&u.is("button")&&(u.click(),t=!1)}else(e.altKey||18==e.which)&&(e.preventDefault(),1==$("body").hasClass("showaccesskeys")?$("body").attr("class",""):$("body").attr("class","showaccesskeys"))
if(t){switch(e.which){case 9:break
case 10:case 13:enterAltCtrlTextBreak(e)||($(".default").length>0?($(".default").click(),t=!1):null!=e.currentTarget.activeElement.offsetParent&&"ui-search-input"==e.currentTarget.activeElement.offsetParent.className||(a=OPT_ENTER))
break
...
break
case 38:s&&(t=appxPutCursor(i.col,i.row-r))
break
case 39:s&&(t=appxPutCursor(i.col+1,i.row))
break
case 40:s&&(t=appxPutCursor(i.col,i.row+r))
break
case 48:case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:e.ctrlKey?49==e.which?a=OPT_DIR_PROC_1:50==e.which&&(a=OPT_DIR_PROC_2):optionTriggered>0&&(digits.push(parseInt(String.fromCharCode(e.which))),0==--optionTriggered&&(a=parseInt(digits.join("")),digits=[]),t=!1)
break
