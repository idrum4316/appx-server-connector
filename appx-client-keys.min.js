...
var l=p.position().top/21,d=Math.floor(p.height()/21)+l
_?i.row-o<l&&(s=!1,appxwidgetcallback(OPT_SCROLL_DOWN)):i.row+o>d&&(s=!1,appxwidgetcallback(OPT_SCROLL_UP))}if(e.which>=37&&e.which<=40){if(e.target&&$(e.target).hasClass("appxitem")&&!r){var T="appxitem_"+i.col+"_"+i.row
T==$(e.target).attr("id")&&(s=!1)}s&&(appx_session.showCursor=!0)}if(e.which>=65&&e.which<=90&&e.altKey){var h=$(".appx-shortcut-"+e.which)
